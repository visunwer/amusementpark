...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	ДвижениеАктивныеПосещения.ВидДвижения = ВидДвиженияНакопления.Расход;
	ДвижениеАктивныеПосещения.Основание = Основание;
	ДвижениеАктивныеПосещения.ВидАттракциона = ВидАттракционаАбонемента;
	ДвижениеАктивныеПосещения.КоличествоПосещений = 1;
...
//  *ВидАттракциона - СправочникСсылка.ВидыАтрракционов
